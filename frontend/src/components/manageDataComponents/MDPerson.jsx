...
const MDPerson = () => {
    ...
    return (
        <div className='DFUniversalContainer'>
            <h3 className='DFUniversalTitle'>Manage Person Form</h3>
                ...
                <div className='DFUniversalRow'>
                    <div className='DFUniversalData'>
                        <label>
                            ...
                            <input className='DFUniversalFields' type="text" name="name"
                                   placeholder="First Name & Last Name" value={name} onChange={onChange}/>
                        </label>
                    </div>
                    <div className='DFUniversalData'>
                        <label>
                    ...
                    <div className='DFUniversalData'>
                        <label>
                            ...
                            <input className='DFUniversalFields' type="text" name="telephone"
                                   placeholder="(000) 000-0000" value={telephone} onChange={onChange}/>
                        </label>
                    </div>
                </div>
                ...
                <div className='DFUniversalRow'>
                    <div className='DFUniversalData'>
                        <label>
                            ...
                            <input className='DFUniversalFields' type="text" name="address"
                                   placeholder="123 Random Place Blvd. W, Lethbridge AB" value={address} onChange={onChange}/>
                        </label>
                    </div>
                    <div className='DFUniversalData'>
                        <label>
                ...
                <div className='DFUniversalRow'>
                    <div className='DFUniversalData'>
                        <label>
                            ...
                            <input className='DFUniversalFields' type="text" name="height" placeholder="000 cm" value={height} onChange={onChange}/>
                        </label>
                    </div>
                    <div className='DFUniversalData'>
                        <label>
                            <div className='DFUniversalInnerTitle'>Weight (lbs)<br/></div>
                            <input className='DFUniversalFields' type="text" name="weight" placeholder="000 lbs." value={weight} onChange={onChange}/>
                        </label>
                    </div>
                    <div className='DFUniversalData'>
                        <label>
                            <div className='DFUniversalInnerTitle'>Aliases<br/></div>
                            <input className='DFUniversalFields' type="text" name="aliases"
                                   placeholder="One Eyed Willy" value={aliases} onChange={onChange}/>
                        </label>
                    </div>
                </div>
                ...
                <div className='DFUniversalRow'>
                    <div className='DFUniversalData'>
                        <label>
                            ...
                            <input className='DFUniversalFields' type="text" name="associatedVehicles"
                                   placeholder="2018 Honda Civic LX" value={associatedVehicles} onChange={onChange}/>
                        </label>
                    </div>
                    <div className='DFUniversalData' td>
                        <label>
                            <div className='DFUniversalInnerTitle'>Associates<br/></div>
                            <input className='DFUniversalFields' type="text" name="associates"
                                   placeholder="Bill Benson" value={associates} onChange={onChange}/>
                        </label>
                    </div>
                    <div className='DFUniversalData'>
                        <label>
                            <div className='DFUniversalInnerTitle'>Flags<br/></div>
                            <input className='DFUniversalFields' type="text" name="flags"
                                   placeholder="Violent Tendencies, HPV Positive, etc." value={flags} onChange={onChange}/>
                        </label>
                    </div>
                </div>
                ...
                <div className='DFUniversalRow'>
                    <div className='DFUniversalData'>
                        <label>
                            ...
                            <input className='DFUniversalFields' type="text" name="tattoos"
                                   placeholder="Scar on left cheek" value={tattoos} onChange={onChange}/>
                        </label>
                    </div>
                </div>
